...
A local Model Context Protocol (MCP) server that exposes read-only GitHub repository analysis tools over stdio.
It can be connected to Claude Desktop, Cursor, VS Code, or any MCP-compatible host that supports local servers.
